...
describe "Conference command" do
  it "should put one caller in conference and then hangup" do
    ...
    conference.next_event.should be_a_valid_conference_command
  ...
  it "should put two callers into a conference and then hangup" do
    ...
    conference1.next_event.should be_a_valid_conference_command
    ...
    conference2.next_event.should be_a_valid_conference_command
