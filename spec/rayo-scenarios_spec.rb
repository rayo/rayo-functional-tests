...
describe "Call Scenarios" do
  describe "Incoming call transferred in parallel" do
    before do
      ...
      @employee1 = @rayo.dial(tropo1_dial_options).should have_dialed_correctly
      @employee2 = @rayo.dial(tropo1_dial_options).should have_dialed_correctly
      @employee3 = @rayo.dial(tropo1_dial_options).should have_dialed_correctly
    ...
    after :each do
      ...
      @employee1.last_event?(@config['rayo_queue']['last_stanza_timeout']).should == true
    end
  end
