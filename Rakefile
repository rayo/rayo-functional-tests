...
RSpec::Core::RakeTask.new(:hudson => ["ci:setup:rspec"]) do |spec|
  spec.pattern = ['**/tropo2-answer*_spec.rb','**/tropo2-jmx*_spec.rb','**/tropo2-transfer*_spec.rb','**/tropo2-redirect*_spec.rb','**/tropo2-reject*_spec.rb','**/tropo2-conference*_spec.rb']
end
